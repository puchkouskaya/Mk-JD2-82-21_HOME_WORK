...
<html>
    ...
    <body>
        ...
        <h1>ВНИМАНИЕ!!! Такой пользователь уже зарегистрирован! Выберите другой логин!<h1>
        <br>
        <h2>Для регистрации на сайте, пожалуйста, заполните повторно все следующие поля:<h2>
            <table>
                <tbody>
                    <tr>
                        <td>Логин:</td>
